...
class ETGsettingType extends AbstractStructBase
{
     ...
     * @uses \Autovista\Technics\EnumType\ISOcountryType::valueIsValid()
     * @uses \Autovista\Technics\EnumType\ISOcountryType::getValidValues()
     * @param string $iSOcountryCode
     * @return \Autovista\Technics\StructType\ETGsettingType
     */
    public function setISOcountryCode($iSOcountryCode = null)
    {
        if (!\Autovista\Technics\EnumType\ISOcountryType::valueIsValid($iSOcountryCode)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $iSOcountryCode, implode(', ', \Autovista\Technics\EnumType\ISOcountryType::getValidValues())), __LINE__);
        }
     ...
     * @uses \Autovista\Technics\EnumType\ISOlanguageType::valueIsValid()
     * @uses \Autovista\Technics\EnumType\ISOlanguageType::getValidValues()
     * @param string $iSOlanguageCode
     * @return \Autovista\Technics\StructType\ETGsettingType
     */
    public function setISOlanguageCode($iSOlanguageCode = null)
    {
        if (!\Autovista\Technics\EnumType\ISOlanguageType::valueIsValid($iSOlanguageCode)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $iSOlanguageCode, implode(', ', \Autovista\Technics\EnumType\ISOlanguageType::getValidValues())), __LINE__);
        }
     ...
     * @uses \Autovista\Technics\EnumType\ISOcurrencyType::valueIsValid()
     * @uses \Autovista\Technics\EnumType\ISOcurrencyType::getValidValues()
     * @param string $iSOcurrencyCode
     * @return \Autovista\Technics\StructType\ETGsettingType
     */
    public function setISOcurrencyCode($iSOcurrencyCode = null)
    {
        if (!\Autovista\Technics\EnumType\ISOcurrencyType::valueIsValid($iSOcurrencyCode)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $iSOcurrencyCode, implode(', ', \Autovista\Technics\EnumType\ISOcurrencyType::getValidValues())), __LINE__);
        }
